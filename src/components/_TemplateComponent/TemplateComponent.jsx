...
function TemplateFunction(props) {
    ...
    useEffect(() => {
        dispatch({
        // TODO: STEP 1 - We created id in this component and now want to use it to GET information from the database. Create a type that will trigger a Saga. Go to _template.saga.js.
